...
<body class="menubar-hoverable header-fixed ">
	...
	<script type="text/javascript">
			...
			for(var i=0;i<data.length;i++){
				table+="<tr>"+
						...
						table+="<span data-toggle='modal' data-target='.open-modal' data-backdrop='static' data-keyboard='false'>"+
								"<button type='button'class='btn ink-reaction btn-floating-action btn-xs btn-warning'data-toggle='tooltip' data-placement='top' title='edit' onClick=\"edit('"+data[i].subprog_id+"','"+data[i].subprog_title+"','"+data[i].term+"','"+data[i].sem+"','"+data[i].year+"','"+data[i].prog_id+"')\"><i class='fa fa-edit'></i></button>"+
							   "</span>"+
		...
		function edit(subprog_id,subprog_title,term,sem,year,prog_id){
