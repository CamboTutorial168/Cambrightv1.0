...
/**
 * Servlet implementation class TimeUpdated
 */
@WebServlet("/TimeUpdated")
public class TimeUpdated extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			t.setTime_id(request.getParameter("time_id"));
			response.setContentType("text/plain");
			if(new TimeDAO().updateTime(t)==true){
